...
const createResearchPapersTableSql =
  "CREATE TABLE research_Papers (paper_id INTEGER PRIMARY KEY AUTO_INCREMENT, paper_title VARCHAR(256), conference VARCHAR(256), publish_date DATE)";
const createAuthorsPapersTableSql =
  "CREATE TABLE authors_papers (author_no INT NOT NULL,paper_id INT NOT NULL,FOREIGN KEY(author_no) REFERENCES authors(author_no), FOREIGN KEY(paper_id) REFERENCES research_papers(paper_id))";

const insertAuthors =
  "INSERT INTO authors (author_name, university, date_of_birth, h_index, gender, mentor) VALUES ('Taddeo Taill','Hatyai University','1969-02-16',7,'Male', NULL),('Modestia Reoch','Hatyai University','1974-05-08',1,'Genderfluid',1),('Vlad Schroter','Zhengzhou University of Technology','1971-11-15',5,'Male',1),('Genny Odhams','Perm State University','1974-06-06',8,'Female',2),('Amberly Hinzer','Perm State University','1962-03-18',2,'Female',2), ('Bartolemo Roja','Universidad de Zaragoza','1973-07-18',1,'Male',3), ('Adara Biagi','Mahamakut Buddhist University','1980-06-23',3,'Female',3), ('Mollie Marle','Hatyai University','1961-06-20',3,'Female',4), ('Brittni Quincey','Instituto Universitario Aeronáutico','1951-08-20',3,'Female',4), ('Blakelee Richmont','University of Maine','1983-06-02',6,'Female',5),('Roxie Volant','Henderson State Univerisity','1956-02-24',8,'Female',7), ('Brier Ferronier','Universidad Pedagógica Veracruzana','1968-09-17',9,'Female',4), ('Jarad Foux','Universidad de Zaragoza','1966-12-31',5,'Male',7), ('Allix Guidini','Pebble Hills University','1961-01-22',1,'Female',8), ('Worthington Bende','Universidad de Zaragoza','1957-02-25',1,'Male',8);";
...
const insertAuthorsPapers =
  "INSERT INTO authors_papers (author_no, paper_id) VALUES (10,1),(13,2),(9,3),(14,4),(4,5),(9,6),(2,7),(9,8),(9,9),(1,10),(10,11),(15,12),(3,13),(12,14),(6,15),(6,16),(10,17),(9,18),(1,19),(13,20),(1,21),(14,22),(15,23),(13,24),(4,25),(4,26),(7,27),(12,28),(13,29),(15,30)";
const InsertFirstAuthorsMentor =
  "UPDATE authors SET mentor = 10 WHERE author_no = 1";
